...
@section('layout-content')
    <form  method="POST"
        ...
        <div class="form-group{{ $errors->has('key') ? ' has-error' : '' }}">
            ...
            <input id="key" type="text" class="form-control" name="key" value="{{ old('key', $setting->key) }}" required
                   autofocus>
        ...
        <div class="form-group{{ $errors->has('value') ? ' has-error' : '' }}">
            ...
            <input id="value" type="text" class="form-control" name="value" value="{{ old('value', $setting->value) }}"
                   required autofocus>
