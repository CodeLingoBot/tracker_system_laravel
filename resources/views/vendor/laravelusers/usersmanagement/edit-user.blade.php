                        ...
                        {!! Form::open(array('route' => ['users.update', $user->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')) !!}
                            ...
                            <div class="row">
                                <div class="col-md-4 form-group{{ $errors->has('accession') ? ' has-error' : '' }}">
                                    <label for="accession" class="control-label">{{ __('users.edit.accession') }}</label>
                                ...
                                <div class="col-md-4 form-group{{ $errors->has('payment_day') ? ' has-error' : '' }}">
                                    <label for="payment_day" class="control-label">{{ __('users.edit.payment_day') }}</label>
                                ...
                                <div class="col-md-4 form-group{{ $errors->has('payment_monthy') ? ' has-error' : '' }}">
                                    <label for="payment_monthy" class="control-label">{{ __('users.edit.payment_monthy') }}</label>
