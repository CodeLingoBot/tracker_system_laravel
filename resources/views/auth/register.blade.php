                        ...
                        <div class="col-md-8">
                            <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                    <label for="name" class="control-label">{{ __('auth.register.name') }}</label>
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                    <label for="email" class="control-label">{{ __('auth.register.email') }}</label>
                                ...
                                <div class="form-group">
                                    <label for="password-confirm" class="control-label">{{ __('auth.register.confirm_password') }}</label>
